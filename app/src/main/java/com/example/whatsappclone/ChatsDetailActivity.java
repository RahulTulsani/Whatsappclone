...
public class ChatsDetailActivity extends AppCompatActivity {
    ...
    private ActivityChatsDetailBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String revieverId = getIntent().getStringExtra("userId");
        ...
        final ChatAdapter chatAdapter = new ChatAdapter(messageModels,this,revieverId);
        ...
        final String senderRoom = senderId + revieverId;
        final String receiverRoom = revieverId+ senderId;
